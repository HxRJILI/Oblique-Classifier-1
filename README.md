# Oblique Classifier 1 (OC1) Implementation

An open-source implementation of the Oblique Classifier 1 (OC1) decision tree algorithm (Murthy, Kasif, Salzberg 1994).
...
You will need [Python 3.x](www.python.org) and `pip` installed.
